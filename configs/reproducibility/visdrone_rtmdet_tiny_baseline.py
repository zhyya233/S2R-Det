...
test_evaluator = dict(
    ann_file=
    'data/links/visdrone2019_det/coco_annotations/visdrone2019_det_testdev.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    proposal_nums=(
...
val_evaluator = dict(
    ann_file=
    'data/links/visdrone2019_det/coco_annotations/visdrone2019_det_val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    proposal_nums=(
...
work_dir = 'outputs/visdrone/rtmdet_tiny_baseline'
